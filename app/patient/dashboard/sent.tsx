  ...
  return (
    <View style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.heading}>Your Document shared successfully</Text>
        <Text style={styles.subtext}> </Text>
        <TouchableOpacity style={styles.button} onPress={handleContinue}>
          <Text style={styles.buttonText} onPress={() => router.push('/patient/dashboard/home')}>Go to Dashboard</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
