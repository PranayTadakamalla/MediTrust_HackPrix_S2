...
export default function SelectScreen() {
  ...
  const startEntranceAnimation = () => {
    // Start with heart transition out
    setTimeout(() => {
      Animated.parallel([
        // Heart shrinks and fades out
  ...
  return (
    <View style={styles.container}>
      {/* Heart Transition Overlay - Only show when needed */}
      {showOverlay && (
        <Animated.View
          style={[
            styles.heartOverlay,
      ...
      >
        {/* Register Button - EXACT SAME AS ORIGINAL */}
        <TouchableOpacity
        ...
        {/* Sign-in Button - EXACT SAME AS ORIGINAL */}
        <TouchableOpacity
